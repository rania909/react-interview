  ...
  return (
    ...
    >
      ...
      <Card.Body>
        ...
        <Card.Image showSkeleton maxDelay={5000} src={movie.url} height={400} width="100%" alt={"Image for " + movie.title} onError={({ currentTarget }) => (currentTarget.src = "/default_image.png")} />
      </Card.Body>
